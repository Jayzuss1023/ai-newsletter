...
/**
 * Categories can be string s (simple RSS) or objects (RSS with attributes)
 */
 ...
 *
 * @params rawCategories - Categories in any format from RSS parsr
...
function normalizeCategories(
  ...
  return rawCategories
    .map((cat) => {
      ...
      // XML-parsed category object with content in _
      if (
        typeof cat === "object" &&
        cat !== null &&
        typeof cat._ === "string"
