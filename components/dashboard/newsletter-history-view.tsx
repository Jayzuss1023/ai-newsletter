      ...
      <div className="container mx-auto py-12 px-6 lg:px-8 space-y-8">
        ...
        <div className="flex items-center justify-between">
          ...
          <Button
            ...
            disabled={isPending}
            className="hover:bg-destructive/80 transition-all"
          >
        ...
        {/* Metadata Card */}
        <Card className="transition-all hover:shadow-lg border-2 border-cyan-600/20 dark:border-cyan-500/20">
          <CardHeader>
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-sm">
              <div className="flex items-start gap-3">
                <div className="bg-linear-to-br from-cyan-500 to-teal-600 text-white shrink-0 mt-0.5 inline-flex items-center justify-center size-8">
              ...
              <div className="flex items-start gap-3">
                <div className="inline-flex size-8 items-center justify-center rounded-md bg-linear-to-br from-cyan-500 to-teal-500 text-white shrink-0 mt-0.5">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    ...
                    {newsletter.feedsUsed.length > 0 ? "s" : ""}
                  </p>
                </div>
              </div>
