      ...
      <Card className="transition-all hover:shadow-lg">
        ...
        <CardContent className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            <Textarea
              id="user-input"
              placeholder="Add any specific instructions, tone preferences, target audience details, or topics to focus on... (e.g., `Include issue number 99`, `Focus on secureity topics`, `Keep it casual`)"
              value={userInput}
          ...
          <Button
            ...
            size="lg"
            className="w-full bg-linear-to-r from-cyan-5o0 to-teal-600 hover:from-cyan-600 hover:to-teal-700 text-white"
          >
