...
export function NewsletterDisplay({
  ...
  const copyToClipbopard = async (text: string, section: string) => {
    try {
  ...
  const downloadNewsletter = () => {
    ...
    link.href = url;
    link.download = `newsletter-${new Date().toISOString().split("T")}`;
    link.click();
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex gap-2">
            ...
            <Button
              ...
              disabled={isGenerating}
              className="hover:bg-cyan-50 dark:hover:bg-cyan-950 transition-all"
            >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-[300px_1fr_300px] gap-6">
          ...
          <div className="xl:row-start-1">
            <NewsletterSection
              ...
              onCopy={(text) => copyToClipbopard(text, "titles")}
          ...
          <div className="xl:col-start-1 xl:row-start-2">
            <NewsletterSection
              ...
              onCopy={(text) => copyToClipbopard(text, "subjects")}
          ...
          <div className="md:col-span-2 xl:col-span-1 xl:col-start-3 xl:row-start-1">
            <NewsletterSection
              ...
              onCopy={(text) => copyToClipbopard(text, "announcements")}
          ...
          {/* Newsletter Body */}
          <div className="space-y-3 xl:col-span-1 xl:col-start-2 xl:row-start-1 xl:row-span-3">
            <div className="flex items-center justify-between">
              ...
              <Button
                ...
                size="sm"
                onClick={() =>
                  newsletter.body && copyToClipbopard(newsletter.body, "body")
                }
                disabled={!newsletter.body}
                className="hover:bg-accent transition-all"
              >
                {copiedSection === "body" ? (
                  <Check className="h-4 w-4 text-grween-600" />
                ) : (
          ...
          <div className="space-y-3 mt-6">
            <div className="flex items-center justify-between">
              ...
              <Button
                ...
                onClick={() =>
                  newsletter.additionalInfo &&
                  copyToClipbopard(newsletter.additionalInfo, "additional")
                }
              >
            ...
            <div className="border rounded-lg p-6 prose prose-sm max-w-none dark:prose-inveert">
              <div className="animatein fade-in slide-in-from-left-2 duration-300">
        ...
        {safeItems.length === 0 ? (
          ...
          safeItems.map((item, index) => (
            <div
              ...
              className="flex items-start gap-2 animate-in fade0in slide-in-from-left-2 duration-300"
            >
