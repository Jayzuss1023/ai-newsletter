        ...
        <div className="container mx-auto py-12 px-6 lg:px-8">
          <Card className="transition-all hover:shadow-lg">
            ...
            <CardDescription className="text-base">
              Please sign in to view your newsletter
            </CardDescription>
          </Card>
        </div>
      </div>
  ...
  return (
    <div className="min-h-screen bg-linear-to-b from-white to-gray-50 dark:from-black dark:to-gray-950">
      <div className="container mx-auto py-12 px-6 lg:px-8 space-y-12">
        ...
        {!isPro && (
          <Card className="border border-cyan-600 dark:border-cyan-400 bg-linear-to-br from-cyan-50 to-teal-50 dark:from-cyan-950/30 dark:to-teal-950/30 transition-all hover:shadow-lg">
            <CardHeader>
              <div className="flex items-center gap-3">
                <div className="bg-linear-to-br from-cyan-500 to-teal-600 text-white inline-flex items-center justify-center">
                  <Crown className="h-6 w-6" />
                </div>
                <div>
                  <CardTitle className="text-3xl bg-linear-to-r from-cyan-600 to-teal-600 bg-clip-text text-transparent">
                    Upgrade to Pro
                  </CardTitle>
